                    ...
                    <div class="post-content-area mb-100">
                        ...
                        <div class="world-catagory-area">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="title">Your Search Results:</li>
                                    ...
                                    @forelse ($results as $result)
                                        ...
                                        <div class="single-blog-post post-style-4 d-flex align-items-center">
                                            ...
                                            <div class="post-thumbnail">
                                                <img src="{{ url('/storage/blog_images/' . $result->image) }}"
                                                    alt="no image">
                                            </div>

                                            <!-- Post Content -->
                                            <div class="post-content">
                                                <a href="{{ route('view.blog', $result->slug) }}" class="headline">
                                                    <h5>{{ $result->title }}</h5>
                                                </a>
                                                <p class="line-clamp">
                                                    {{ $result->content }}
                                                ...
                                                <!-- Post Meta -->
                                                <div class="post-meta">
                                                    <p><a href="#" class="post-author">{{ $result->user->name }}</a>
                                                        on
                                                        <a href="#"
                                                            class="post-date">{{ $date->parse($result->published_at)->isoFormat('lll') }}</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
